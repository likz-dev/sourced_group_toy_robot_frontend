<template>
  <v-container>
    ...
    >
      ...
      >
        <v-card
          ...
          align="center"
        >
          <img v-if="showRobot(x+'-'+y)" src="@/assets/images/robot.png"
    ...
    <v-container style="max-width: 360px; margin-top: 16px;">
      ...
      <v-row style="margin-top: -20px">
        <v-btn color="primary" block @click="placeRobot()">
          Place
        </v-btn>
      </v-row>
      ...
      <v-row style="margin-top: 20px">
        <v-col style="padding: 0; margin-right: 8px">
          <v-btn color="secondary" block @click="rotateRobotLeft()">
            Left
          </v-btn>
        </v-col>
        <v-col style="padding: 0; margin-left: 8px">
          <v-btn color="secondary" block @click="rotateRobotRight()">
            Right
          </v-btn>
        </v-col>
      </v-row>
      <v-row style="margin-top: 20px">
        <v-btn color="success" block @click="moveRobot()">
          Move
        </v-btn>
      </v-row>
      <v-row style="margin-top: 20px">
